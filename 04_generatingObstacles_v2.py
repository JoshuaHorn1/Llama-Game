"""Generating Obstacles Component - Version 2
- Randomly generates moving cactus with random scale and random speed
"""
...
CACTI_SIZE_1 = []  # lists holding the different y positions for generating the cactus's
CACTI_SIZE_2 = []
CACTI_SIZE_3 = []
...
while running:
    ...
    if random.randint(0, 100) < 50:
        cactus_scale = random.uniform(1, 3)  # Random scale
        print(cactus_scale)
        cactus_y = screen_height - floor_image.get_height() * cactus_scale
        cacti.append(Cactus(cactus_scale, screen_width, cactus_y, random.uniform(1, 3)))

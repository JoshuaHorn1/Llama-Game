"""Obstacles Collision Component - Version 1
- Added collision detection between llama and cacti
- Once llama collides with a cacti, display end screen and then quit after 2 seconds
"""
...
while running:
    ...
    for cactus in cacti:
        ...
        # Check for collision between llama and cactus
        llama_rect = pygame.Rect(x_position, y_position, 100, 100)
        cactus_rect = pygame.Rect(cactus.cactus_x, cactus.cactus_y, cactus.image.get_width(), cactus.image.get_height())
